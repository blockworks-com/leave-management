...
/// <summary> Helper class to access common properties of Outlook Items. This class uses reflection to call the common
/// members of all Outlook items. Because of the use of reflection, all calls through this class will be significantly
/// slower than executing the same call against a strongly typed object. </summary> <remarks> Uses the IDispatch
/// interface of the Outlook object model to access the common properties of Outlook items regardless of the actual item
/// type. This prevents having to test for and cast to a specific object in order to access common properties.
/// 
/// Usage example:
/// 
/// OutlookItem myItem = new OutlookItem(olApp.ActiveExplorer.Selection[1]); Debug.WriteLine(myItem.EntryID);

#endregion Readme and Usage
...
namespace LeaveManagement.OutlookAddIn2010
{
    internal class OutlookItem
    {
        ...
        #endregion OutlookItem Constants
        ...
        public Outlook.OlObjectClass Class
        {
            get
            {
                ...
                {
                    // Note: instantiate dummy ObjectClass enumeration to get type. type =
